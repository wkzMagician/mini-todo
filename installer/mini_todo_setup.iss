...
OutputDir=..\dist
OutputBaseFilename=mini_todo-{#MyAppVersion}-windows-x64-setup
...
Source: "..\build\windows\x64\runner\Release\resources\*"; DestDir: "{app}\resources"; Flags: ignoreversion recursesubdirs createallsubdirs
